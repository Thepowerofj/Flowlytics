...
> **Flowlytics:** Prefer `BUILD_SPEC.md` (same playbook with product pointers). Product CAPs live in `docs/PRODUCT_SPEC.md` and `docs/REQUIREMENTS_TRACEABILITY.md`. Keep `docs/PROJECT_STATE.md` current.
